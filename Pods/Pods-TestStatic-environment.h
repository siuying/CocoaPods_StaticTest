...
// SampleLib
#define COCOAPODS_POD_AVAILABLE_SampleLib
#define COCOAPODS_VERSION_MAJOR_SampleLib 0
#define COCOAPODS_VERSION_MINOR_SampleLib 0
#define COCOAPODS_VERSION_PATCH_SampleLib 1
